...
label(final$Glargine)="Glargine dose/kg"
...
tab1 <- final_table(final,c('Sex','Ethnicity',"Insurance_Type","New_Onset_Diabetic",
    "Age","Height","Weight","HbA1c_Closest_to_Admisson","Median_Income","Glargine"),
    group=final$group,margin=2,single=0,ron=2)

tab1a <- final_table(cpg,c('Sex','Ethnicity',"Insurance_Type","New_Onset_Diabetic",
    "Age","Height","Weight","HbA1c_Closest_to_Admisson","Median_Income","Glargine"),
    group=cpg$October.1.2014.Flag,margin=2,single=0,ron=2)

x <- final_table(cpg,c('Sex'),group=cpg$October.1.2014.Flag,margin=2,single=0,ron=2)
...
```{r, results='asis',tidy=TRUE, echo=FALSE}
kable(tab1,caption="Table 1a.  Descriptive statistics.  Statistics given are N(%), mean±SD, or median (25th %ile, 75th %ile).  * denotes that the Mann-Whitney test was used, and ** denotes that Fisher's exact test was used.")
```
\
...
```{r, results='asis',tidy=TRUE, echo=FALSE}
kable(tab_primarya,caption="Table 2.  Comparison of study outcomes.  Statistics given are N(%), mean±SD, or median (25th %ile, 75th %ile).  * denotes that the Mann-Whitney test was used, and ** denotes that Fisher's exact test was used.")
```
